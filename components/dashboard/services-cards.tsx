      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {services.map((service) => {
          ...
          return (
            ...
            >
              <div className="absolute inset-0 bg-violet-500 opacity-[0.05] dark:opacity-[0.10] pointer-events-none" />
              <div className="absolute -bottom-6 -right-6 w-20 h-20 rounded-full bg-violet-500 opacity-15 blur-2xl pointer-events-none" />
              {/* Header do Card */}
