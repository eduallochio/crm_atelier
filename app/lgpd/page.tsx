          ...
          <div className="grid md:grid-cols-2 gap-6 mt-8">
            ...
            <Card className="border-2 hover:border-blue-300 transition-colors">
              ...
              <CardContent className="space-y-3">
                ...
                <Link href="mailto:dpo@meuateliersistema.com.br?subject=Solicitação de Acesso aos Dados">
            ...
            <Card className="border-2 hover:border-red-300 transition-colors">
              ...
              <CardContent className="space-y-3">
                ...
                <Link href="mailto:dpo@meuateliersistema.com.br?subject=Solicitação de Exclusão de Dados">
                  <Button className="w-full mt-4" variant="outline">
                    <Mail className="h-4 w-4 mr-2" />
                    Solicitar Exclusão
                  </Button>
            ...
            <Card className="border-2 hover:border-purple-300 transition-colors">
              ...
              <CardContent className="space-y-3">
                ...
                <Link href="mailto:dpo@meuateliersistema.com.br?subject=Solicitação de Portabilidade de Dados">
                  <Button className="w-full mt-4" variant="outline">
                    <Mail className="h-4 w-4 mr-2" />
            ...
            <Card className="border-2 hover:border-pink-300 transition-colors">
              ...
              <CardContent className="space-y-3">
                ...
                <Link href="mailto:dpo@meuateliersistema.com.br?subject=Revogação de Consentimento">
                  <Button className="w-full mt-4" variant="outline">
                    <Mail className="h-4 w-4 mr-2" />
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Envie email para <a href="mailto:dpo@meuateliersistema.com.br" className="text-blue-600 hover:underline font-medium">dpo@meuateliersistema.com.br</a> informando 
