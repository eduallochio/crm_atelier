...
export async function GET() {
  try {
    ...
    return NextResponse.json({
      ...
      max_users_pro:       parseInt(map.max_users_pro)      || 3,
      max_clients_pro:     parseInt(map.max_clients_pro)    || 999999,
      ...
      promo_banner_deadline:    map.promo_banner_deadline ?? '',
    })
  } catch (error) {
...
export async function PUT(request: NextRequest) {
  try {
    ...
    const entries: [string, string][] = [
      ...
      ['max_users_pro',       String(parseInt(body.max_users_pro)      || 3)],
      ['max_clients_pro',     String(parseInt(body.max_clients_pro)    || 999999)],
      ...
      ['promo_banner_deadline',  String(body.promo_banner_deadline ?? '')],
    ]
